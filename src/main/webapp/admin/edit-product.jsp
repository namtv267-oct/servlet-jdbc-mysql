...
<link rel="stylesheet"
	href="<c:url value='/common/assets/bootstrap5.0.2/css/bootstrap.min.css'/> ">
<link rel="stylesheet"
	href="<c:url value='/common/assets/admin/dashboard.css'/>">
</head>
<body>
	<%@page import="model.*"%>
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<form action="/CRUD/admin/edit-product" method="post" class="w-75">
					<div class="mb-3 mt-3">
					...
					<div class="mb-3 mt-3">
						<label for="src" class="form-label">Src:</label> <input
							type="text" class="form-control" id="src" name="src">
					</div>
					<div class="mb-3 mt-3">
